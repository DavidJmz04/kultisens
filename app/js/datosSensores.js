...
function extraerDatos(mediciones, numeroSensores) {
    ...
    for (let i = 0; i < todasMediciones.length; i++) {
        datasetProvisional.push({ data: [], backgroundColor: 'transparent', borderColor: colors[i], borderWidth: 4, pointBackgroundColor: colors[i], label: celdas[i] })
        var horas = []
